...
import VideoToRoutineCard from "../ConstantComponets/VideoToRoutineCard";
import MainButton from "../ConstantComponets/MainButton";

const VideoCallToRoutine2 = () => {
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={{  alignItems: "center", marginTop: 100 }}>
        <View style={{ height: 24 , marginBottom:15}}>
          <Text style={{fontFamily:"Nunito-Regular", fontWeight:'600', fontSize:14}}>Unable to find a perfect routine for Geetanjali?</Text>
        </View>
...
export default VideoCallToRoutine2;
