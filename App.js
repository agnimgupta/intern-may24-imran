...
import VideoCallToRoutine from "./ConsultationScreenComponents/VideoCallToRoutine";
import VideoCallToRoutine2 from "./ConsultationScreenComponents/VideoCallToRoutine2";
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen
            name="VideoToRoutine2"
            component={VideoCallToRoutine2}
            options={{
              header: (props) => (
                <CustomHeader
                  Name="Geetanjali Shah"
